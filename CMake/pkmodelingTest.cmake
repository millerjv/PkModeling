# This file contains CMake functions and macros used when testing PkModeling
# libraries and modules.

#-----------------------------------------------------------------------------
# Create PkModeling executable wrapper for testing the selected command-line modules.
#
# Arguments - Input
#   EXECUTABLE_NAME - name of the executable wrapper
#   MODULE_NAME     - name of the module to test
#
macro(PkModeling_add_test_executable)
  set(options
  )
  set(oneValueArgs
    EXECUTABLE_NAME
...
#-----------------------------------------------------------------------------
# PkModeling wrapper for add_test that set test LABELS using MODULE_NAME value
